										...
										<c:forEach var="tempUserDonation"
											...
											<li class="user-i mb-3 border-bottom pl-5">
												...
												<div class="user-detail-i">
													...
													<p class="user-donation-h-i mb-1">Ngày quyên góp: <%-- ${JSPDataFormat.dateFormat(tempUserDonation.createdDate)} --%>
														${tempUserDonation.createdDate}
														</p>
													<p class="user-donation-i mb-1">Số tiền quyên góp: ${JSPDataFormat.moneyFormat(tempUserDonation.money)}</p>
												</div>
											</li>
