                ...
                <div class="col-lg-6">
                    <div class="bg-light p-3 border rounded mb-4">
                      ...
                      <ul class="list-unstyled pl-3 mb-0">
                        <li class="mb-2"><strong class="text-black">Tài khoản:</strong> <span>donation 2</span></li>
                        <li class="mb-2"><strong class="text-black">Họ và tên:</strong> <span>QG002</span> </li>
                        <li class="mb-2"><strong class="text-black">Email:</strong> <span>donation 2</span></li>
                        <li class="mb-2"><strong class="text-black">Số điện thoại:</strong> <span>02/01/2024</span></li>
                        <li class="mb-2"><strong class="text-black">Địa chỉ:</strong> <span>15/01/2024</span></li>
                        <li class="mb-2"><strong class="text-black">Ngày lập:</strong> <span>organization 2</span></li>
                        <li class="mb-2"><strong class="text-black">Số lần quyên góp thành công: </strong> <span>0123456799</span></li>
                        <li class="mb-2"><strong class="text-black">Trạng thái:</strong> <span>1</span>
                          <!-- <span >Mới tạo</span>
                    ...
                    <ul class="comment-list">
                        ...
                        <li class="comment">
                          ...
                          <div class="comment-body">
                            <h3></h3>
                            <div class="meta" style="color: #373b3e !important;" th:text=""></div>
                            <p></p>
                          </div>
                        </li>
