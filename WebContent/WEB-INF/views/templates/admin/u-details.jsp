				...
				<div class="col-lg-6">
					<div class="bg-light p-3 border rounded mb-4">
						...
						<ul class="list-unstyled pl-3 mb-0">
							<li class="mb-2"><strong class="text-black">Tài
									khoản:</strong> <span>${user.userName}</span></li>
							<li class="mb-2"><strong class="text-black">Vai
									trò:</strong> <span>${user.role.roleName}</span></li>
							<li class="mb-2"><strong class="text-black">Họ và
									tên:</strong> <span>${user.fullName}</span></li>
							<li class="mb-2"><strong class="text-black">Email:</strong>
								<span>${user.email}</span></li>
							<li class="mb-2"><strong class="text-black">Số điện
									thoại:</strong> <span>${user.phoneNumber}</span></li>
							<li class="mb-2"><strong class="text-black">Địa
									chỉ:</strong> <span>${user.address}</span></li>
							<li class="mb-2"><strong class="text-black">Ngày
									lập:</strong> <span>${user.createdDate}</span></li>
							<li class="mb-2"><strong class="text-black">Số lần
									quyên góp thành công: </strong> <span></span></li>
							<li class="mb-2"><strong class="text-black">Trạng
									thái:</strong> <span>${JSPDataFormat.userStatusFormat(user.status)}</span>
								<!-- <span >Mới tạo</span>
                          <span >Đang quyên góp</span>
                          <span>Kết thúc quyên góp</span>
                          <span>Đóng quyên góp</span> --></li>
