						...
						<table class="table table-striped table-content">
							<thead class="tb-head-title">
								<tr>
									...
									<th scope="col" class="th-custom"><p>user id</p></th>
									<th scope="col" class="th-custom"><p>donation id</p></th>
							...
							<tbody>
								<c:forEach var="tempData" items="${datas.content}">
									...
									<tr>
										<td><p>${tempData.id}</p></td>
										<th scope="row">
											<p class="d-name">${tempDate.name}</p>
										</th>
										<td><p>${tempDate.name}</p></td>
										<td><p>${tempDate.money}</p></td>
										<td><p>${tempDate.createdDate}</p></td>
										<td><p>${tempDate.status}</p></td>
										<td><p>${tempDate.user.id}</p></td>
										<td><p>${tempDate.donation.id}</p></td>
										<td><p>${tempDate.note}</p></td>
										<td class="action-c">
											<button class="btn btn-success" title="Xác nhận"
											...
											<button class="btn btn-success" title="Hủy"
												onclick="redirectToDonateLink()">
												<span class="content-btn-text">Hủy</span><span
													class="content-btn-icon"><i
													class="fa-solid fa-circle-dollar-to-slot"></i></span>
											</button> <script>
												function redirectToComfirmLink() {
													window.location.href = "${comfirmLink}";
												}

												function redirectToCancelLink() {
