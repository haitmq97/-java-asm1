    ...
    <div class="container vh-100 bg-light ">
        <div class="d-flex h-100 justify-content-center flex-column" style="position: relative; top: -20px">
            <div class="d-flex justify-content-center flex-column">
                <h1 class="display-1 font-weight-bold text-center">403</h1>
                <h3 class="text-center font-weight-bold">Xin lỗi!</h3>
                <p class="text-center d-flex align-items-center justify-content-center"><span class="error mr-2"><i class="fa-solid fa-circle-exclamation"></i></span> Có vẻ như bạn không có quyền truy cập nội dung này</p>
