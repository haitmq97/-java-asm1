...
<div class="form-container donate-form " id="success-donate">
	...
	<div class="container form-main">
		<p class="text-align-center font-weight-bold"><i class="fa-solid fa-heart" style="font-size:24px; color:red;"></i>Cám ơn bạn đã ủng hộ<i class="fa-solid fa-heart" style="font-size:24px; color:red;"></i></p>
		<p class="text-align-center ">Vui lòng chờ <span class="font-weight-bold">Quản trị viên</span> xác nhận</p>
