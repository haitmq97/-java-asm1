...
<body>
	<div class="donation" id="donations">
		...
		<div class="page">
			<input id="currentPage" type="hidden" name="currentPage"
				...
				page:</label> <select id="pageSize" name="size" onchange="entriesSelect()">
		...
		<div class="pagebtn">
			...
			<div>
				...
				<p>
					<a href="?page=${donations.totalPages}&size=${currentSize}">${donations.totalPages}</a>
				</p>
			</div>
	...
	<script>
		function entriesSelect() {
			...
			$.ajax({
				type : "GET",
				url : "<c:url value='/test/list'> </c:url>",
				data : {
